...
def plot_acc_freq_models(bins, models=["2.7B-greedy", "1.3B-greedy", "125M-greedy"], markers=["D", 'H', 'p']):
    plt.clf()
    ...
    ax_marg_x.set_xlabel(f"# Co-occurrence within distance {spans[dist]}")
    
    # global settings and save
    plt.savefig(f"output_figs/acc_freq_{spans[dist]}.jpeg", dpi=150)
